...
```
#Parent directory ("C:/Users/mccahill/Documents/GitHub/WFH_Git/NEON-Data-Skills/tutorials/R/primer-raster-data")
...
<a href="{{ site.baseurl }}/raster-res-extent-pixels-r"> *The Relationship Between Raster Resolution, Spatial extent & Number of Pixels* tutorial</a>. 
...
#load sp package before raster package
library(sp)
library(raster)
library(rgdal)
...
#setwd("pathToDirHere")
setwd("C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data/SJER/DigitalTerrainModel/SJER2013_DTM.tif")
```	
...
# Create raster layer
r = raster("C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data/SJER/DigitalTerrainModel/SJER2013_DTM.tif")

# Inspect raster layer
class(r)

#try manualing downloading?
download.file("C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data/SJER/DigitalTerrainModel/SJER2013_DTM.tif", mode="wb")

#Check the validity of your raster with rgdal directly. Using the "GDALinfo" function you can do this without reading the raster into R.
GDALinfo(system.file("external/test.ag", package="sp")[1])

#When using Rmarkdown, if you set the working directory in one code chunk it will not carry over to the other code chunks. 
