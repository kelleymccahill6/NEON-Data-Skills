...
In 
<a href="/raster-data-r" target="_blank">a previous tutorial</a>, 
...
#setwd("pathToDirHere")
#works here:
setwd("C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data")
getwd()
#won't let me change directory
#setwd("C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data/SJER/DigitalTerrainModel")??

#Tried moving spatial data to primer raster data folder...confused about dev aten branch
...
getwd()
rasterlist1 <-  list.files('C:/Users/mccahill/Documents/GitHub/NEON-DS-Field-Site-Spatial-Data/SJER/RGB', full.names=TRUE)
rasterlist1
#?list.files
```
...
```{r list-files-tif}
rasterlist2 <-  list.files('NEON-DS-Field-Site-Spatial-Data/SJER/RGB', full.names=TRUE, pattern="tif")
rasterlist2
```
